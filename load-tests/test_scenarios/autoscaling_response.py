"""Test scenario: Autoscaling response time"""
import logging
import time
...
class AutoscalingResponseUser(HttpUser):
    """User for autoscaling response test"""
    wait_time = between(0.1, 0.2)  # Reduced RPS for lower load
