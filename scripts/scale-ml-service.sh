#!/bin/bash
# Scale ML service to target task count
...
echo "Scaling ML service:"
echo "  Cluster: $CLUSTER_NAME"
echo "  Service: $ML_SERVICE"
...
if [ $? -ne 0 ] || [ -z "$SERVICE_CHECK" ] || [ "$SERVICE_CHECK" = "None" ]; then
    echo "❌ Error: Could not find service '$ML_SERVICE' in cluster '$CLUSTER_NAME'"
    echo "  AWS CLI output: $SERVICE_CHECK"
    echo ""
    echo "Please verify:"
    echo "  1. Cluster name is correct: $CLUSTER_NAME"
    echo "  2. Service name is correct: $ML_SERVICE"
